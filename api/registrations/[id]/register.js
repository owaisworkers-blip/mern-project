...
import { registerForEvent } from '../../../../backend/src/controllers/registrationController.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Check roles (customer, organizer, or admin)
    checkRole(req, 'customer', 'organizer', 'admin');
