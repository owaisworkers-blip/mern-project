...
export default function Pass() {
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-sm text-gray-600">Open this page once online; passes will remain available offline.</p>
      <div className="grid md:grid-cols-2 gap-3">
        {regs.map(r => (
          <div key={r._id} className="bg-white dark:bg-slate-800 rounded shadow p-4">
